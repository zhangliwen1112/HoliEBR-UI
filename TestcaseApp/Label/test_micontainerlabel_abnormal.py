# -*- coding: utf-8 -*- 
# @Time : 2021/5/20 16:09 
# @Author : 张丽雯 
# @File : test_micontainerlabel_abnormal.py 
# @中文描述 :  标签-MI产出容器，异常场景测试用例
...
class Test_micontainerlabel_Abnormal:
    # 新增
    ...
    def test_micontainerlabel_code_abnormal_001(self, code, name, desc, zpl):
    ...
    def test_micontainerlabel_code_abnormal_002(self, code, name, desc, zpl):
        log.info("开始执行用例%s" % sys._getframe().f_code.co_name)
        label_add(code, name, desc, zpl)
    ...
    def test_micontainerlabel_code_abnormal_003(self, code, name, desc, zpl):
        log.info("开始执行用例%s" % sys._getframe().f_code.co_name)
        label_add(code, name, desc, zpl)
    ...
    def test_micontainerlabel_name_abnormal_001(self, code, name, desc, zpl):
        log.info("开始执行用例%s" % sys._getframe().f_code.co_name)
        label_add(code, name, desc, zpl)
    ...
    def test_micontainerlabel_name_abnormal_002(self, code, name, desc, zpl):
        log.info("开始执行用例%s" % sys._getframe().f_code.co_name)
        label_add(code, name, desc, zpl)
    ...
    def test_micontainerlabel_zpl_abnormal_001(self, code, name, desc, zpl):
        log.info("开始执行用例%s" % sys._getframe().f_code.co_name)
        label_add(code, name, desc, zpl)
