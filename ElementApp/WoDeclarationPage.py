...
submit = "//div[@class='v-dialog v-dialog--active v-dialog--persistent v-dialog--scrollable']//span[text()='确定']"
cancel = "//div[@class='v-dialog v-dialog--active v-dialog--persistent v-dialog--scrollable']//span[text()='取消']"
#展开、折叠小标签
